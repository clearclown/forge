...
pub fn build_tool_list() -> Vec<Tool> {
    vec![
        ...
        Tool::new(
            ...
            "Get the L2 bank PortfolioManager state (cash_cu, lent_cu, borrowed_cu, \
        ...
        Tool::new(
            ...
            "Find agents that match a set of model patterns and optional filters. Returns \
             ...
             beyond the basic /v1/forge/providers list.",
            schema(json!({
                "type": "object",
                "properties": {
                    "model_patterns": {
        ...
        Tool::new(
            "forge_mind_init",
            "Initialise the ForgeMindAgent with a system prompt and optimizer. The agent will \
        ...
        Tool::new(
            "forge_mind_state",
            "Get the current ForgeMindAgent state: harness version number, first 80 chars of \
        ...
        Tool::new(
            ...
            "Run N self-improvement cycles. Each cycle has the MetaOptimizer propose a new \
             ...
             1.0, the new harness is kept. CU is deducted per proposal if a CuPaidOptimizer \
             is configured.",
            schema(json!({
                "type": "object",
                "properties": {
        ...
        Tool::new(
            "forge_mind_budget",
            "Update the ForgeMindAgent's CU budget limits. Omit any field to leave it \
        ...
        Tool::new(
            "forge_mind_stats",
            "Get ForgeMindAgent lifetime statistics: total cycles run, how many were kept vs \
