...
//!
//! Scrapes the current ledger state into a ForgeMetrics snapshot and returns
...
use forge_ledger::metrics::ForgeMetrics;
use std::sync::OnceLock;

fn metrics_instance() -> &'static ForgeMetrics {
    static INSTANCE: OnceLock<ForgeMetrics> = OnceLock::new();
    INSTANCE.get_or_init(ForgeMetrics::new)
}
