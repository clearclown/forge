...
नोड्स अपने निष्क्रिय CU को अन्य नोड्स को ब्याज पर उधार दे सकते हैं। एक छोटा नोड CU उधार लेता है, बड़े मॉडल तक पहुंच प्राप्त करता है, अधिक CU कमाता है, ब्याज सहित चुकाता है। कोई अन्य वितरित इन्फरेंस प्रोजेक्ट कंप्यूट उधार की पेशकश नहीं करता — इस क्षेत्र के हर प्रमुख प्रोजेक्ट के प्रतिस्पर्धी विश्लेषण के माध्यम से पुष्टि की गई। यही वह इंजन है जो स्व-सुधार लूप को सभी के लिए आर्थिक रूप से व्यवहार्य बनाता है, न कि केवल उनके लिए जिनके पास पहले से शक्तिशाली हार्डवेयर है।

## आर्किटेक्चर (Architecture)

```
┌─────────────────────────────────────────────────┐
│  L4: डिस्कवरी (forge-agora)                      │
│  एजेंट मार्केटप्लेस, प्रतिष्ठा एकत्रीकरण,           │
│  Nostr NIP-90, Google A2A भुगतान विस्तार         │
├─────────────────────────────────────────────────┤
│  L3: इंटेलिजेंस (forge-mind)                      │
│  AutoAgent स्व-सुधार लूप,                         │
│  हार्नेस मार्केटप्लेस, मेटा-ऑप्टिमाइज़ेशन          │
├─────────────────────────────────────────────────┤
│  L2: वित्त (forge-bank)                          │
│  CU उधार, यील्ड ऑप्टिमाइज़ेशन, क्रेडिट स्कोरिंग    │
├─────────────────────────────────────────────────┤
│  L1: अर्थव्यवस्था (forge — यह रेपो)              │
...
- [रणनीति](strategy.md) — प्रतिस्पर्धी स्थिति, उधार स्पेक, 5-परत आर्किटेक्चर
- [मौद्रिक सिद्धांत](monetary-theory.md) — CU क्यों काम करता है: Soddy, बिटकॉइन, PoUW, AI-only मुद्रा
...
- [एजेंट इंटीग्रेशन](agent-integration.md) — SDK, MCP, उधार वर्कफ़्लो
...
- [A2A भुगतान](a2a-payment.md) — एजेंट प्रोटोकॉल के लिए CU भुगतान विस्तार
