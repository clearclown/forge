...
**Три речі, які не робить жоден інший проект:**

### 1. Обчислення = Валюта

Кожен інференс — це обмін. Провайдер заробляє CU, споживач витрачає CU. Без блокчейну, без токенів, без ICO. CU підкріплений фізикою — електроенергією, спожитою для корисної роботи.
...
│  Паралелізм пайплайну, MoE шардинг експертів,   │
│  iroh mesh, Nostr discovery, OpenAI API         │
└──────────────────┬──────────────────────────────┘
                   │
┌──────────────────▼──────────────────────────────┐
│  Економічний шар (Forge)                        │
│  Леджер CU, двосторонні підписи, gossip,        │
│  динамічне ціноутворення, корінь Меркла, безпека│
└──────────────────┬──────────────────────────────┘
                   │
┌──────────────────▼──────────────────────────────┐
│  Шар безпеки                                    │
│  Аварійний стоп, політики бюджету, запобіжники, │
│  детектор швидкості, поріг схвалення людиною    │
└──────────────────┬──────────────────────────────┘
                   │ опціонально
┌──────────────────▼──────────────────────────────┐
│  Зовнішні мости                                 │
